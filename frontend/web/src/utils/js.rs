//! wasm_bindgen bindings to every JS helper defined in index.html.
...
#[wasm_bindgen]
extern "C" {
    #[wasm_bindgen(js_namespace = window, js_name = __loadGoogleMaps)]
    pub fn load_google_maps(api_key: &str);
